...
public enum ModArmorMaterials implements ArmorMaterial {
    DRAGON_SCALE("dragon_scale", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.DRAGON_SCALES.get());
    });
